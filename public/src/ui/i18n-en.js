...
registerMessages({
  ...
  'Ambiance': 'Vibe',
  'Adversaire': 'Opponent',
  'Crée ton compte — gratuit': 'Create your account — free',
  'Gagne de l’XP à chaque partie': 'Earn XP in every match',
  'Puzzle du jour — nouveau chaque jour': 'Daily puzzle — new every day',
  'Kits & habillages en boutique': 'Kits & skins in the shop',
  'Pass Saison — bonus d’XP': 'Season Pass — XP bonus',
  'Joueurs à pouvoirs à collectionner': 'Collect players with powers',
  'Ordinateur': 'Computer',
  'Toi': 'You',
  'Joueur 1': 'Player 1',
  'Joueur 2': 'Player 2',
