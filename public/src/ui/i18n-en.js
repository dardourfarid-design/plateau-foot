...
registerMessages({
  ...
  'Partager le résultat': 'Share the result',
  'Lien copié !': 'Link copied!',
  'Partage indisponible': 'Sharing unavailable',
  'Je viens de gagner {score} sur Tactic Master.': 'I just won {score} on Tactic Master.',
  'Battu {score} sur Tactic Master. Prends ta revanche pour moi.': 'Lost {score} on Tactic Master. Get my revenge.',
  'Match nul {score} sur Tactic Master. Départage-nous.': 'Drew {score} on Tactic Master. Come break the tie.',
  'Meilleure action : {n} passes.': 'Best play: {n} passes.',
  ...
  // Cartes d'abonnement + Pack Fondateurs (chemin d'achat — étaient en FR côté EN)
  'MENSUEL': 'MONTHLY',
  'TRIMESTRIEL': 'QUARTERLY',
  '/mois': '/month',
  '/3 mois': '/3 months',
  'MEILLEURE VALEUR': 'BEST VALUE',
  'Économise 33% vs mensuel': 'Save 33% vs monthly',
  'Tous les kits Saison 1': 'All Season 1 kits',
  '1 joueur Rare offert': '1 free Rare player',
  'Accès aux kits S2 en avant-première': 'Early access to S2 kits',
  "S'abonner": 'Subscribe',
  'ÉDITION LIMITÉE': 'LIMITED EDITION',
  'Devenir Fondateur — 9,99 €': 'Become a Founder — €9.99',
  ...
  'kits pour 1,99 €/mois.': 'kits for €1.99/month.',
  'Ton pass débloque': 'Your pass unlocks',
  'kits en ce moment.': 'kits right now.',
