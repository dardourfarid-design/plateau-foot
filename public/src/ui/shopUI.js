...
const FALLBACK_THEMES = [
  ...
  { id: 'stadium-night', name: 'Stadium Night',   description: 'Ambiance broadcast : pions lumineux, feuille de match en verre.',  price_cents: 199, currency: 'eur', config: { vertTerrain: '#0A1728', vertTerrainClair: '#0E2038', bleuEquipe: '#2563EB', rougeEquipe: '#DC2626', accent: '#FFD87A', skin: 'stadium-night' } },
  { id: 'arcade-turf',   name: 'Arcade Turf',     description: 'Pions chunky, ombres franches, énergie arcade.',                   price_cents: 199, currency: 'eur', config: { vertTerrain: '#178A3E', vertTerrainClair: '#1EA34A', bleuEquipe: '#2563EB', rougeEquipe: '#E11D48', accent: '#FACC15', skin: 'arcade-turf' } },
