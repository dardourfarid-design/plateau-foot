...
const CACHE_NAME = 'tactic-master-v5'; // v4 : + dialogs.js (oubli qui cassait TOUT le site en mode cache/hors-ligne : l'import échouait et aucun bouton ne répondait)
const STATIC_ASSETS = [
  './index.html',
  './styles.css',
  './skins.css',
