...
// versionnée sous supabase/functions/_shared/engine/ (seule zone embarquée au
// déploiement Supabase). Ce test garantit que la copie n'a pas dérivé de la
// source public/src/engine/ : sans lui, une modif du moteur non resynchronisée
// ferait valider le client mais rejouer un moteur périmé côté serveur.
// Correctif en cas d'échec : `node tools/sync-edge-engine.mjs`.

describe('copie moteur de l’Edge Function (_shared/engine)', () => {
